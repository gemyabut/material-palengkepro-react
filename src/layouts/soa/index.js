              ...
              <Box className="soa-print-area">
                ...
                >
                  ...
                  <Stack direction="row" spacing={1} className="no-print">
                    <Button variant="outlined" startIcon={<Icon>print</Icon>} onClick={handlePrint}>
                      Print
                    </Button>
                ...
                {/* Charge-Type Balance Summary — M1 Q3/C1 (Phase D.3) */}
                <MDTypography variant="overline" color="text">
                  Charge-Type Balance Summary
                </MDTypography>
                <SoaChargeTypeSummary sections={soa.sections} />
                ...
                <Box mt={2} sx={{ display: "none", "@media print": { display: "block" } }}>
                  ...
                  <MDTypography variant="caption" color="secondary">
                    Generated by {getUsername()} &nbsp;|&nbsp; PalengkeProPH &nbsp;|&nbsp;{" "}
                    {soa.as_of}
                  </MDTypography>
                </Box>
              </Box>
